...
const Filter = ({ show }) => {
  return (
    <div
      id="modalProductsFilterContainer"
      className="min-w-min max-w-1/4 fixed left-0 bg-white h-full z-10 p-4 flex flex-col gap-3 hidden"
    >
      <button onClick={show} className="absolute top-1 right-1">
        <GrClose color="#6D6D6D" />
      </button>
      <div>
...
//     <>
//       <button
//         className="w-50 h-50 bg-red-500 border-2 border-black absolute top-0 right-0"
//         onClick={mostrar}
//       >
//         ocultar
//       </button>
//       <div
//         id="carrito"
//         className="min-w-min max-w-1/4 fixed left-0 bg-white h-full z-10 p-4 flex flex-col gap-3"
//       >
